...
R is notorious for a steep learning curve. Much of this has to do with how R was designed and how it is maintained and developed.

R’s base functionality is extended with packages. An R package is a collection of functions, data, and documentation that to work with data. Package development in R is organic and anybody can create and share them. While the popularity of R is thanks to the proliferation of user-built packages, this sort of organic development means that are many ways to do the same thing, often at varying levels of efficiency, code readability, and system cost. This can also mean learning the language and doing basic tasks can be very difficult if you do not understand the language well.
